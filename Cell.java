...
public class Cell extends JPanel {
    ...
    private static final Color VISITED_COLOR = new Color(175, 238, 238);  // Pale Turquoise
    private static final Color CONSIDERING_COLOR = new Color(135, 206, 250);  // Light Sky Blue
    private static final Color PATH_COLOR = new Color(255, 255, 0);  // Yellow
